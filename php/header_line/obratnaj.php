...
if($phone && $name &&  $email && $message){
    ...
    <form action="" method="POST">
        <table><tr>
                    <td>Имя:</td><td> <input type="text" name="name" size="20" maxlength="20" value=""></td></tr>
                <tr>    
                    <td>Номер телефона:</td><td> <input type="text" name="phone" size="20" maxlength="20" value=""></td></tr>
                <tr>
                    <td>Email:</td><td> <input type="text" name="email" size="50" maxlength="50" value=""></td></tr>
                <tr>
                    <td>Текст сообщения:</td><td> <textarea name="message" cols="35" rows="5"></textarea></td></tr>
                <tr>
                    <td></td><td> <input type="submit" name="buton"      value="   Enter   " /></td></tr>    
    </form>
